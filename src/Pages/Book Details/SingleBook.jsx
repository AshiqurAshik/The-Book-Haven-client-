    ...
    <div className="p-10 w-full bg-[#FAF9F6] dark:bg-[#3B2A23] rounded-2xl shadow-lg flex flex-col items-center transition-colors duration-500">
      <div className="w-full max-w-5xl flex flex-col md:flex-row gap-8">
        ...
        <div className="md:w-2/3 flex flex-col justify-start text-[#3B2C24] dark:text-[#F8F4E8] transition-colors duration-500">
          ...
          <p className="mb-2"><span className="font-semibold">Publication Year:</span> {book.publicationYear}</p>
          <p className="mb-2"><span className="font-semibold">Uploaded by:</span> {book.userEmail}</p>
          <p className="mt-4 leading-relaxed"><span className="font-semibold">Summary:</span> {book.summary}</p>
        </div>
      </div>
