...
const Footer = () => {
  return (
    <footer
      ...
      style={{ backgroundColor: '#F8F4E8', color: '#3B2C24' }}
    >
      {/* Navigation Links */}
      ...
      {/* Social Icons */}
      <nav className="flex justify-center mt-4 gap-6 text-2xl">
        <a className="text-[#3B2C24] hover:text-[#D17E5E] transition-transform transform hover:scale-110">
          <SiX />
        </a>
        <a className="text-[#3B2C24] hover:text-[#D17E5E] transition-transform transform hover:scale-110">
          <SiYoutube />
      ...
      {/* Footer Note */}
      <aside className="mt-6 text-sm text-center text-[#3B2C24]">
